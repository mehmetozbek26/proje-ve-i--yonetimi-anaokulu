    ...
    public partial class PersonelKayit : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                int idd = Convert.ToInt32(dataGridView1.CurrentRow.Cells["PersonelId"].Value);
            ...
            {
                var st = dataGridView1.CurrentRow.Cells["Departman"].Value.ToString();
                if (st.Equals("OGRETMEN"))
                    MessageBox.Show("Lütfen Öğretmen Üzerindeki Dersleri Sildikten Sonra Deneyiniz");
                else
