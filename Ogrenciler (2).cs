    ...
    public partial class Ogrenciler : Form
    {
        ...
        private void Ogrenciler_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //dataGridView1.Columns["OgrenciId"].Visible = true;
                ...
                dataGridView1.Columns["PostaKodu"].Visible = false;
                dataGridView1.Columns["EvTel"].Visible = false;
                dataGridView1.Columns["KanGrubu"].Visible = false;
                dataGridView1.Columns["Uyruk"].Visible = false;
                dataGridView1.Columns["KimlikSeriNo"].Visible = false;
                dataGridView1.Columns["DogumYeri"].Visible = false;
                dataGridView1.Columns["DogumTarihi"].Visible = false;
                dataGridView1.Columns["Dogumili"].Visible = false;
                dataGridView1.Columns["Dogumilce"].Visible = false;
                dataGridView1.Columns["Mahalle"].Visible = false;
                dataGridView1.Columns["Koy"].Visible = false;
                dataGridView1.Columns["Cilt"].Visible = false;
                dataGridView1.Columns["Aile"].Visible = false;
                dataGridView1.Columns["SiraNo"].Visible = false;
                dataGridView1.Columns["VerilisYeri"].Visible = false;
                dataGridView1.Columns["KayitNo"].Visible = false;
                dataGridView1.Columns["Resim"].Visible = false;
                dataGridView1.Columns["KayitTarihi"].Visible = false;
                dataGridView1.Columns["DavranisSorunu"].Visible = false;
                dataGridView1.Columns["Yapilanlar"].Visible = false;
                dataGridView1.Columns["YasitlariylaIliskisi"].Visible = false;
                dataGridView1.Columns["Fobileri"].Visible = false;
                dataGridView1.Columns["SevdigiYiyecekler"].Visible = false;
                dataGridView1.Columns["GecirdigiHastaliklar"].Visible = false;
                dataGridView1.Columns["Diyet"].Visible = false;
                dataGridView1.Columns["VerilisYeri"].Visible = false;
                dataGridView1.Columns["SaglikSorunlari"].Visible = false;
                dataGridView1.Columns["RuhsalDurum"].Visible = false;
                dataGridView1.Columns["Protez"].Visible = false;
                dataGridView1.Columns["Alerjiler"].Visible = false;
                dataGridView1.Columns["SaglikSorunlari"].Visible = false;
                dataGridView1.Columns["ilac"].Visible = false;
                dataGridView1.Columns["Ameliyatlar"].Visible = false;
